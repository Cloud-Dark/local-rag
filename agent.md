...
| **Frontend** | Vanilla HTML/CSS/JS | Web UI 3 tab (Training, List, Search) |
...
|---|---|---|---|
| `files` | File(s) | No | File PDF/TXT/MD (bisa multiple) |
...
Akses di `http://localhost:3000/ui` — Single Page Application dengan 3 tab:
...
2. **File Upload** — Upload file PDF/TXT/MD (bisa multiple)
...
Form search dengan input query, menampilkan hasil:
...
Format yang didukung: **.pdf**, **.txt**, **.md** saja.  
